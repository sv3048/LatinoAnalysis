...
class JJH_EFTVars(Module):
    ...
    def analyze(self, event):
        ...
        if (BoostJH or JJH) :
         ...
         nunu_pz = LL.Pz()
         #nunu_m  = 30.0
         nunu_m = LL.M()   # this variable is modified  for Off-Shell category 
        ...
        #anomalous coupling part --- comment it out for now ( To do : check this commented part is aligned)
        ...
        ### WH part remove it completely in the last 
