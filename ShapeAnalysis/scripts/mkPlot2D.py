    ...
    def makePlot(self, inputFile, outputDirPlots, variables, cuts, samples, plot, legend, groupplot):
        ...
        for cutName in self._cuts:
            ...
            for variableName, variable in self._variables.iteritems():
                ...
                print "len(variable['name']) ", len(variable['name'])
                ...
                tcanvas = ROOT.TCanvas("c_2D_" + variableName, "c_2D_" + variableName, 200, 200, 800, 600)
                ...
                for sampleName, plotdef in plot.iteritems():
                    ...
                    #print "np.array(rango[0]) = ", np.array(rango[0])
                    #print "np.array(rango[1]) = ", np.array(rango[1])
                    ...
                    histogram2D = ROOT.TH2D(sampleName+"_2DHist_"+variableName, sampleName+"_2DHist_"+variableName, len(np.asarray(rango[0]))-1, np.asarray(rango[0]), len(np.asarray(rango[1]))-1, np.asarray(rango[1]))
